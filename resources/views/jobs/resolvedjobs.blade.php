    ...
    <div class="row ">
            ...
            <div class="card py-0 my-0 border-0 BreadCrumb_card">
                <div class="card-body py-0 my-0 border-bottom mb-3">
                    <div class="d-flex  justify-content-between mt-5 mb-0 ">
                        ...
                        <div class="notification notification2  ">
                            <div class="" id="collapseExample" role="button">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pl-0 ">
            <div class="menu p-3">
                ...
                <p class=" mx-2"><a href="{{url('inprogress-job')}}"> In progress Jobs</a></p>
                <p class="mx-2">Auto Resolved Jobs</p>
                <p class="active mx-2"><a href="{{url('resolved-job')}}">Resolved Jobs </a></p>
