...
<div class="container-fluid addcontractor companydetails  p-0">
    ...
    <div class="row p-4">
        <div class="col-lg-6 my-3">
            <form action="{{route('store.auto.responder')}}" method="post" class="card customshadow">
                @csrf
                @method('put')
                <div class="card-body">
                    <h4 class="card-title">Email</h4>
                    <div class="card-text px-4">
                        <textarea name="email_description" class="form-control" id="" cols="30" rows="10">{{$setting->email_description}}
                        </textarea>
                        <button type="submit" class="btn btn-suc btn-block mt-4"> Save</button>
                    </div>
                </div>
