    ...
    <div class="row my-lg-5">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12   ">
            <div class="d-flex justify-content-between menu w-100">
                ...
                <p class="selected"><a href="licences">Licences</a></p>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="cards d-lg-flex justify-content-lg-around align-self-center ">
                <div class="card w-100" style="box-shadow: none;">
                    <div class="card-body mt-5 ">
                        <article class="card-text mt-5 p-5" style="color: #020202 !important;">9.9 Licences <br> License will be based n total number of properties <br> Need further discussion on below: <br> 1 Active Property= 1
                        License <br> 1 Archive Property= ¼ License or perhaps archive properties are deleted after 30 or 90 days <br> <br> Need to understand
                        system’s impact if we keep inactive property.</article>
                    </div>
                </div>
            </div>
        </div>
