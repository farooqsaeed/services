            ...
            <div class="col-lg-10 offset-lg-1  ">
                <div class="row mt-5">
                    <div class="my-3 col-lg-12">
                        ...
                        <input type="text" class="form-control" name="Group_Name" id="" value="{{$group->Group_Name}}"
                    ...
                    <div class="col-lg-4 col-6 offset-lg-4   mt-5">
                        <button id="formbtn" type="submit" class="btn btn-info success btn-block ">Update</button>
                    </div>
                </div>
            </div>
        </form>
