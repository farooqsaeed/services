...
<div class="container-fluid addcontractor  p-0">
    <div class="add  mt-0 ">
        ...
        <span class="span">&nbsp;&nbsp; Create a Child-Group</span>
    </div>
    <div class="p-3">
        <form id="groupform" class="row addform">
            ...
            <div class="col-lg-10 offset-lg-1  ">
                <div class="row mt-5">
                    <div class="my-3 col-lg-12">
                        ...
                        <input type="text" class="form-control" name="" id="" disabled
                            value="{{$group->Sub_Group_Name}}" />
                    </div>
                    <div class="my-3 col-lg-12">
                        <label htmlFor="">Name *</label>
                        <input type="text" class="form-control" required name="Child_Group_Name" id=""
                ...
                <div class="row">
                    ...
                    <div class="my-3 col-lg-12">
                        <input type="hidden" class="form-control" value="{{$group->id}}" name="subgroup_id" id="" />
                    </div>
